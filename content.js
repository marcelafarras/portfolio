  ...
  aiWorks: [
    {
      ...
      status: "In Progress",
      image: "",   // e.g. "assets/ai/n8n-workflow.png"
      link: "",    // e.g. link to video demo or case study
    },
    {
      icon: "🎬",
    ...
    },
    {
      ...
      description: "Full social media visual set — feed posts, stories, reels thumbnails — generated via Midjourney with brand-consistent prompts.",
      status: "In Progress",
      image: "",
      link: "",
    },
    {
      ...
      description: "AI-assisted article production: keyword research → outline → draft → optimization → publish-ready — scalable to 50+ articles/month.",
      status: "In Progress",
      image: "",
      link: "",
    },
  ...
  gallery: [
    {
      ...
      image: "",        // e.g. "assets/works/up-thamrin.jpg"
